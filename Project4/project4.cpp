...
const char* WINDOWTITLE = { "OpenGL / GLUT Sample -- Syed Mahdi" };
...
Display()
{
	...
	glLoadIdentity();
	glColor3f(1., 1., 1.);
	DoRasterString(5., 5., 0., "Syed Mahdi");
...
InitGraphics()
{
	...
	width = 297;
	height = 297;
	unsigned char* EarthTexture = BmpToTexture("CementSmall.bmp", &width, &height);
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glGenTextures(1, &CementTex);
	glBindTexture(GL_TEXTURE_2D, CementTex);
